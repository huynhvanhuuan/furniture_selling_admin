...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<div class="d-flex justify-content-center pt-3 pb-3">
			<h1 class="font-weight-bolder">QUẢN LÝ KHO HÀNG</h1>
		</div>
		<!-- /.content-header -->
			...
			<div class="modal fade" id="create-modal" style="display: none;" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content card card-success">
						...
						<form action="product-detail.html" id="create" novalidate="novalidate" enctype="multipart/form-data">
...
<script>
	function changeColor(colorParam) {
		...
		var selectElements = document.getElementsByClassName('select-color');
		for (let selector of selectElements) {
			if (colorParam == selector) {
