...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<div class="d-flex justify-content-center pt-3 pb-3">
			<h1 class="font-weight-bolder">QUẢN LÝ NGƯỜI DÙNG</h1>
		</div>
		<!-- /.content-header -->
							...
							<div class="card-body">
								<form method="post">
									<button type="submit" class="btn btn-danger font-weight-bolder float-left"
									        onclick="return confirm('Xác nhận khóa các người dùng đã chọn?')">Khóa&nbsp;<i class="fas fa-user-lock"></i></button>
									<table id="user" class="table table-bordered table-striped">
										...
										<tr class="text-center">
											...
											<th class="align-middle">Đăng ký</th>
											<th class="align-middle">Cập nhật</th>
											<th class="align-middle">Khóa</th>
											<th class="align-middle">Trạng thái</th>
										</tr>
										</thead>
										<tbody>
										<tr>
											<th class="text-center align-middle"><input type="checkbox" class="checkBoxId" name="id" value="1"></th>
											<td class="text-center align-middle">1</td>
											<td class="text-center align-middle"><img src="https://robohash.org/koi" alt="koi" width="100"></td>
											<td>
												<ul class="m-0">
													<li>Họ và tên: Koi</li>
													<li>Tên tài khoản: ankoi0310</li>
													<li>Email: huynhvahuuan3620@gmail.com</li>
													<li>Điện thoại: 0787782050</li>
													<li>Giới tính: Nam</li>
												</ul>
											</td>
											<td class="text-center align-middle">09:30:19 19-12-2021</td>
											<td class="text-center align-middle">11:45:13 19-12-2021</td>
											<td class="text-center align-middle text-success">Không khóa</td>
											<td class="text-center align-middle text-success">Hoạt động</td>
											<!--<td class="d-flex justify-content-center">
												<input type="hidden" name="id" value="1"/>
												<button class="btn btn-danger d-block w-100 ml-1 delete" data-toggle="modal"
														data-target="#delete-modal" title="Khóa vĩnh viễn"><i class="fas fa-lock"></i></button>
											</td>-->
										</tr>
										</tbody>
									</table>
